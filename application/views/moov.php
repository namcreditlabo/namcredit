...
<div><center> <h2 style="color : white"> SERVEZ-VOUS...  NAMCREDIT</h2> </center> </div>
       ...
       <div id="imgb">
          <!-- Start Formoid form-->
          <form action="traiter_moov" id="formoid" style="background-color:#FFFFFF;" title="Formulaire d'envoie de crédit" method="post">
            <a href="<?php echo site_url('..\achat\moov') ?> "><?php echo img('moov.jpg','Recharger crédit moov') ; ?></a></br> </br> 
...
function numvalid(){
var expression = /^9[6-9]([-. ]?[0-9]{2}){3}$/; 
if(expression.test(document.getElementById('num').value)==false)

	
  alert('Numéro invalide (Enlevé le 228 ou vérifier que c\'est un numéro MOOV )') ;}
</script>
